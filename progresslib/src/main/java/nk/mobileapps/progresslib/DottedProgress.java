 ...
 * Created by nk
 */
public class DottedProgress extends AlertDialog {
    ...
    public DottedProgress(Context context, String message, int theme, boolean cancelable, OnCancelListener cancelListener) {
        super(context, theme);
    ...
    public DottedProgress(Context context, int theme) {
        super(context, theme);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dotted_progress);
    ...
    private void initProgress() {
        ...
        for (int i = 0; i < spots.length; i++) {
            ...
            v.setBackgroundResource(R.drawable.dotted);
    ...
    public static class Builder {
        ...
        public AlertDialog build() {
            return new DottedProgress(
                    context,
                    messageId != 0 ? context.getString(messageId) : message,
                    themeId != 0 ? themeId : R.style.DottedProgressDefault,
                    cancelable,
                    cancelListener
            );
        }
