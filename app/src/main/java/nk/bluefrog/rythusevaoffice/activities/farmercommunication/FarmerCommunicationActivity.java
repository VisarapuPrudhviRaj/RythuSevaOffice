...
public class FarmerCommunicationActivity extends BluefrogActivity implements SearchableSpinner.SpinnerListener, ResponseListener, SearchableMultiSpinner.SpinnerListener, AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.farmer_communication);
    ...
    private void initViews() {
        ...
        spinnerVillage.setItems(getVillageData(), this);
            ...
            if (Helper.isNetworkAvailable(getApplicationContext())) {
                ...
                try {
                   ...
                   /*
                    ...
                    jobMain.put("IMEI", Helper.getIMEINumber(FarmerCommunicationActivity.this));
    ...
    public void sendRegistrationData(final JSONObject finalString) {
        ...
        askCompactPermissions(new String[]{Manifest.permission.CAMERA, Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.WRITE_EXTERNAL_STORAGE},
                new PermissionResult() {
                    ...
                    public void permissionDenied() {
                        Helper.showToast(FarmerCommunicationActivity.this, getString(R.string.accept_cam_permissions));
                        //setCancelResult();
                    }

                    @Override
                    public void permissionForeverDenied() {
                        openSettingsApp(FarmerCommunicationActivity.this);
                    }
                });
...
//                Helper.showToast(FarmerCommunicationActivity.this,jobj.getString("message"));
                Helper.showToast(FarmerCommunicationActivity.this, getString(R.string.not_submit));
            }
    ...
    public void onError(int responseCode, String error) {
        Helper.showToast(FarmerCommunicationActivity.this, error);
    }
    ...
    private void insertIntoDB() {
       ...
       /* dbHelper.insertintoTable(DBTables.FarmerCommunication.TABLE_NAME, DBTables.FarmerCommunication.cols,
        ...
        Helper.showToast(FarmerCommunicationActivity.this, getString(R.string.submit_suceess));
        finish();
    }
