...
public class FarmerProfileActivity extends BluefrogActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setToolBar(getString(R.string.farmer_profile), "");
        findView();
    }
    ...
    private void findView() {
        ...
        String url = Constants.URL_FARMER_PROFILE+ getIntent().getStringExtra("aadhaar");
